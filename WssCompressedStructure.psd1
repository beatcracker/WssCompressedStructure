#
# Module manifest for module 'WssCompressedStructure'
#
...
GUID = 'd93adab7-0e2a-4b6d-9291-af1b8ec2035a'
...
FormatsToProcess = @('TypeData\WssCompressedStructure.Format.ps1xml')
...
FunctionsToExport = @(
    ...
    'Export-WssCompressedStructureBinary',
    'Get-SpListWssCompressedStructure',
    'Import-WssCompressedStructureBinary',
    'New-WssCompressedStructure',
    'Set-SpListWssCompressedStructure',
    'Test-ValidWssCompressedStructure'
)
